...
const Hero = () => {
  return (
    <div className="relative min-h-screen bg-black pt-18 pb-16 sm:pt-12 sm:pb-16 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex items-center justify-center space-x-2 mb-12">
          ...
          <span className="text-gray-400 text-sm">200+ businesses scaled</span>
        </div>
